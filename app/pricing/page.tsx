...
const Pricing = () => {
  return (
      <div className="font-[Mulish] h-screen relative w-full overflow-hidden bg-slate-900 flex flex-col items-center justify-center rounded-lg">
          <style jsx global> 
              {`
      ...
      <div className="absolute inset-0 w-full h-full bg-slate-900  z-[1] [mask-image:radial-gradient(transparent,white)] pointer-events-none" />
          ...
          <Boxes />
          <div className="heading text-center text-3xl z-20 mb-[40px]">
              <p className="text-white mb-[20px]">Need Custom PDFs?</p>
              <p className="text-[#2ba680] mb-[20px]">We&apos;ve got you covered</p>
              <p className="flex gap-x-[15px]">
                  <span className="text-[#FFD700] text-center">Simple Pricing</span>
                  <span className="text-[#f8f8ff]">No Hidden Fees</span>
              </p>
          </div>
          <div className="payment-info flex flex-wrap w-[80vw] justify-center gap-[30px] z-[2] mb-[30px]">
