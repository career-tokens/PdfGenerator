...
export const Airbnb = ({data}) => {
    ...
    function calculateCost() {
        let value = 0;
        value += data.basicCost.costPerNight*data.basicCost.nights;
        data.additionalCost.forEach((item) => { value += item.cost; });
        return value;
    }
  ...
  return (
      <div className="main bg-white font-[Mulish] py-8 px-8">
          ...
          <div className="layer2 py-8">
              <p className="font-bold text-3xl pb-6">Confirmed : {data.description}</p>
              <div className="part1 flex justify-between pb-6">
                  <div className="box1">
              ...
              <div className="part3 py-6 border-[#c4c4c4] border-b-2">
                  <span className="w-[45%]">
                      <p className="font-bold text-xl">Cost per traveler</p>
                      <p>This trip was <span className="font-bold">{data.basicCost.costPerNight}</span>  per person,per night</p>
                      <p>including taxes and other fees.</p>
                  </span>
              </div>
              <div className="part4 py-6 flex justify-between">
