...
export const TigerCV:React.FC<TigerCVDataProps> = ({data}) => {
  return (<React.Fragment>
    <CSS>
      ...
      <div className="main bg-white  py-8 px-8 flex text-lg dark:bg-black dark:text-gray-300">
      <div className="w-[50%] p-2 flex flex-col">
        <div className="starter flex flex-col justify-center items-center">
          ...
          <div className="links flex flex-wrap px-3 py-1  ">
            ...
            }
            {
              ...
              <div className="flex items-center mr-4 mb-3">
              <img width="25" height="15" className="mr-1 dark:bg-white dark:p-[2px] rounded-full dark:w-[35px] dark:h-[35px]"  src="https://img.icons8.com/color/48/000000/hashnode.png" alt="hashnode"/>
                <span>Blog</span>
              </div>
              </a>
            }
        ...
        <div className="profile flex flex-col  p-2">
          <div className="w-full text-xl p-1 mb-3 font-bold icon box items-center  border-black border-t-2 border-b-2 flex justify-center dark:border-white">
            <img width="25" height="15" className="mr-2 dark:hidden" src="https://img.icons8.com/ios/50/bank-card-front-side--v1.png" alt="bank-card-front-side--v1" />
            <img width="25" height="15" className="mr-2 hidden dark:block dark:bg-white dark:p-[2px] rounded-full dark:w-[35px] dark:h-[35px]" src="https://img.icons8.com/ios-filled/50/bank-card-front-side--v1.png" alt="bank-card-front-side--v1" />
            Profile
          </div>
          {
        ...
        <div className="skills flex flex-col  p-2 pb-0">
          <div className="w-full text-xl p-1 mb-3 font-bold icon box items-center  border-black border-t-2 border-b-2 flex justify-center dark:border-white">
          <img width="25" height="15" className="mr-2 dark:bg-white dark:p-[2px] rounded-full dark:w-[35px] dark:h-[35px]" src="https://img.icons8.com/ios-filled/50/head-with-brain.png" alt="head-with-brain"/>
            Skills
          </div>
          {
        ...
        {data.professionalExperienceNeeded&&<div className="professionalExp flex flex-col  p-2 pb-0">
          <div className="w-full text-xl p-1 mb-4 font-bold icon box items-center  border-black border-t-2 border-b-2 flex justify-center dark:border-white">
          <img width="25" height="15" className="mr-2 dark:bg-white dark:p-[2px] rounded-full dark:w-[35px] dark:h-[35px]" src="https://img.icons8.com/ios-filled/50/manager.png" alt="manager"/>
            Professional Experience
          </div>
          {
            data.professionalExperience.map((item,i) => (
              <div className={`exp${i} mb-4 dark:text-gray-400`} key={i}>
                <p className="font-bold dark:text-neutral-300">{item.position}</p>
                <p className="dark:text-gray-300">{item.company}</p>
                <p>{item.period}</p>
                {
      ...
      <div className="w-[50%] p-2 flex flex-col">
      <div className="openSourceContributions flex flex-col  p-2 pb-0">
          <div className="w-full text-xl p-1 mb-4 font-bold icon box items-center  border-black border-t-2 border-b-2 flex justify-center dark:border-white">
          <img width="25" height="15" className="mr-2 dark:bg-white dark:p-[2px] rounded-full dark:w-[35px] dark:h-[35px]" src="https://img.icons8.com/ios-filled/50/gitlab.png" alt="gitlab"/>
        ...
        <div className="projects flex flex-col  p-2 pb-0">
          <div className="w-full text-xl p-1 mb-4 font-bold icon box items-center  border-black border-t-2 border-b-2 flex justify-center dark:border-white">
          <img width="25" height="15" className="mr-2 dark:bg-white dark:p-[2px] rounded-full dark:w-[30px] dark:h-[30px]" src="https://img.icons8.com/ios-filled/50/folder-invoices--v2.png" alt="folder-invoices--v2"/>
            Projects
          </div>
          {
            data.projects.map((project, i) => (
              <div className={`project ${i} mb-4`} key={i}>
                <p className="text-lg font-bold flex ">
                  <span>{project.title}</span>
                  <a href={project.link}>
                  <img width="25" height="15" className="ml-2 dark:bg-white dark:p-[2px] rounded-full dark:w-[30px] dark:h-[30px]" src="https://img.icons8.com/ios-filled/50/link--v1.png" alt="link--v1"/>
                  </a>
                </p>
